        ...
        ['$stateProvider', '$urlRouterProvider', 'JQ_CONFIG',
            function($stateProvider, $urlRouterProvider, JQ_CONFIG) {
                ...
                $stateProvider
                    ...
                    .state('app.widgetscounter', {
                        url: '/widgetscounter',
                        templateUrl: 'partials/widgets-counter.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['countTo',
                    ...
                    .state('app.widgetsprogress', {
                        url: '/widgetsprogress',
                        templateUrl: 'partials/widgets-progress.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                ...
                .state('app.ui', {
                    ...
                    .state('app.ui.popovers', {
                        url: '/popovers',
                        templateUrl: 'partials/ui-popovers.html'
                    })
                    ...
                    .state('app.ui.dropdowns', {
                        url: '/dropdowns',
                        templateUrl: 'partials/ui-dropdowns.html'
                    })
                    .state('app.ui.grouplisting', {
                        url: '/grouplisting',
                        templateUrl: 'partials/ui-grouplisting.html'
                    })
                ...
                .state('app.form.elementscheck', {
                   ...
                   /* .state('app.ui.faq', {
                    ...
                    .state('app.charts.morrisbar', {
                        url: '/morrisbar',
                        templateUrl: 'partials/charts-morris-bar.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load('ngMorris').then(
                    ...
                    .state('app.charts.morrispie', {
                        url: '/morrispie',
                        templateUrl: 'partials/charts-morris-pie.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load('ngMorris').then(
                    ...
                    /*.state('app.charts.echart', {
                        url: '/echart',
                        templateUrl: 'partials/charts-echart.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load('angular-echarts').then(
                                        function() {
                                            return $ocLazyLoad.load('js/controllers/echarts.js');
                                        }
                                    );
                                }
                            ]
                    ...
                    .state('app.charts.sparklinearea', {
                        url: '/sparklinearea',
                        templateUrl: 'partials/charts-sparkline-area.html'
                    })
                    .state('app.charts.sparklinebar', {
                        url: '/sparklinebar',
                        templateUrl: 'partials/charts-sparkline-bar.html'
                    })
                    .state('app.charts.sparklineother', {
                        url: '/sparklineother',
                        templateUrl: 'partials/charts-sparkline-other.html'
                    })
                ...
                .state('app.layout', {
                    ...
                    .state('app.layout.boxedcollapsed', {
                        url: '/boxedcollapsed',
                        templateUrl: 'partials/layout-boxed-collapsed.html'
                    })
                    .state('app.layout.boxedchat', {
                        url: '/boxedchat',
                        templateUrl: 'partials/layout-boxed-chat.html'
                    })
